    ...
    def __init__(self):
        ...
        async def on_ready():
            ...
            print(f'''{Fore.RESET}
                            ...
                            {Fore.LIGHTBLACK_EX}║ {Fore.LIGHTGREEN_EX}fartbot  {Fore.LIGHTBLACK_EX}                   ║ 
                            {Fore.LIGHTBLACK_EX}║                             ║
                            {Fore.LIGHTBLACK_EX}╚═════════════════════════════╝         
                          ...
                          {Fore.WHITE}You have {Fore.LIGHTGREEN_EX}{len(list(bot.user.friends))}{Fore.WHITE} Friend(s) in friend list.
                              {Fore.LIGHTBLACK_EX}[{nsign}{Fore.LIGHTBLACK_EX}] {Fore.WHITE}Invite Scraper is Active{Fore.WHITE}.
